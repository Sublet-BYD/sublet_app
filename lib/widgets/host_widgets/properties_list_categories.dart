                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          ...
                          onTap: (() {
                            Provider.of<Session_details>(context, listen: false).UpdatePropertyId(propertyObj.id!); // Hard null check is safe since propertyObj must have an id as it is pulled from Firebase.
