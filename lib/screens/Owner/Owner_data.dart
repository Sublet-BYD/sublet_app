...
class Owner_data {
  ...
  void Add_Property(String new_property){ // This function should only be called via Firebase_functions.Add_Property (IMPORTANT)
    plist!.add(new_property);
  }
  void Remove_Property(String old_property){ // This function should only be called via Firebase_functions.Remove_Property (IMPORTANT)
